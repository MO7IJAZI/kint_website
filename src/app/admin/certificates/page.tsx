    ...
    return (
        <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2.5rem' }}>
                <div>
                    <h1 style={{ fontSize: '2rem', marginBottom: '0.5rem' }}>Certificates Gallery</h1>
                    <p style={{ color: 'var(--muted-foreground)' }}>
                        Add certificate images to display on the public Certificates page (max 5)
                    </p>
                </div>
                <button 
            ...
            {showForm && (
                <div className="card" style={{ marginBottom: '2rem', padding: '1.5rem' }}>
                    <h3 style={{ marginBottom: '1.5rem' }}>Add New Certificate</h3>
                        ...
                        <div style={{ marginBottom: '1.5rem' }}>
                            ...
                            {!formData.imageUrl && (
                                <div style={{ marginBottom: '0.5rem' }}>
                                    ...
                                    />
                                    {uploading && <p style={{ fontSize: '0.85rem', color: 'var(--primary)', marginTop: '0.25rem' }}>Uploading...</p>}
                                </div>
                            )}
                        </div>
                ...
                {loading && certificates.length === 0 ? (
                    ...
                    <>
                        ...
                        >
                            ...
                            <span style={{ fontWeight: '600' }}>Add Certificate</span>
                        </div>
                ...
                <div style={{ 
                    ...
                    {certificates.length >= 5 && (
                        <p style={{ 
                            ...
                            Maximum limit reached. Delete a certificate to add a new one.
                        </p>
                    )}
                </div>
            )}
