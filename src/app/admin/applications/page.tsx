...
import { Eye, Check, X, Trash2, Mail, Phone, Linkedin, FileText } from "lucide-react";
    ...
    return (
        <div className="page">
            <div className="page-header">
                ...
                <span className="total-count">Total: {applications.length}</span>
            </div>
                        ...
                        {filteredApplications.map((app) => (
                            <div key={app.id} className={`application-item ${app.status}`}>
                                <div className="app-info">
                                    ...
                                    <p className="app-position">Applied for: <strong>{app.jobOffer.title}</strong></p>
                            ...
                            <div className="detail-section">
                                ...
                                <div className="cover-letter">
                                    {selectedApplication.coverLetter ? (
                                        ...
                                        <p className="not-provided">No cover letter provided</p>
                                    )}
                                </div>
                            </div>
