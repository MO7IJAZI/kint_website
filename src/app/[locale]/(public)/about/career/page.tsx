            ...
            <section className="section">
                <div className="container">
                    ...
                    <div className="intro-section">
                        <h2 className="section-title center">{t('opportunities')}</h2>
                        <h3 className="subtitle center">{t('joinTeam')}</h3>
                    ...
                    <div className="jobs-section">
                        <h2 className="section-title center">{t('currentOpenings')}</h2>
                        ...
                        {loading ? (
                            ...
                            <div className="jobs-list">
                                {jobOffers.map((job) => {
                                    ...
                                    const companyIntro = isRtl && job.companyIntro_ar ? job.companyIntro_ar : job.companyIntro;
                                            ...
                                            <div className="job-header" onClick={() => toggleJob(job.id)}>
                                                <div className="job-header-left">
                                                    ...
                                                    <div className="job-meta">
                                                        {location && <span className="meta-item"><span className="meta-icon">📍</span> {location}</span>}
                                                        {workType && <span className="meta-item"><span className="meta-icon">💼</span> {workType}</span>}
                                                        {contractType && <span className="meta-item"><span className="meta-icon">📋</span> {contractType}</span>}
                                                        {employmentType && <span className="meta-item"><span className="meta-icon">👤</span> {employmentType}</span>}
                                                    </div>
                                                </div>
                                                ...
                                                <div className="job-details">
                                                    {companyIntro && (
                                                        <div className="job-section">
                                                            <h4>{t('aboutPosition')}</h4>
                                                            <div dangerouslySetInnerHTML={{ __html: companyIntro }} />
                                                        </div>
                                                    )}
