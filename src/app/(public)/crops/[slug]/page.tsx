        ...
        <div style={{ backgroundColor: '#fdfdfd', minHeight: '100vh' }}>
            ...
            <section style={{ padding: '3rem 0 2rem', backgroundColor: 'white', borderBottom: '1px solid #eee' }}>
                <div className="container-technical">
                    <nav style={{ marginBottom: '1.5rem', fontSize: '0.8rem', color: '#999', fontWeight: 700 }}>
                        <Link href="/" style={{ color: '#999' }}>HOME</Link> /
                        <Link href="/crop-farming" style={{ color: '#999' }}> CROP GUIDES</Link> /
                        <span style={{ color: 'var(--primary)' }}> {crop.name.toUpperCase()}</span>
                    </nav>
                    <h1 style={{ 
                        ...
                        CROP GUIDES: <span style={{ color: 'var(--primary)' }}>{crop.name}</span>
                    </h1>
                </div>
            </section>
                        ...
                        <div>
                            ...
                            <div style={{ marginBottom: '5rem' }}>
                                ...
                                <div
                                    ...
                                    dangerouslySetInnerHTML={{ __html: crop.description || 'Detailed technical information is currently being updated.' }}
                                />
                            </div>
                                    ...
                                    {crop.stages.map((stage) => (
                                        <div key={stage.id} className="card" style={{
                                            ...
                                            <div style={{
                                                ...
                                                <span style={{ fontSize: '0.7rem', fontWeight: 800, color: 'var(--primary)', textTransform: 'uppercase', opacity: 0.7 }}>DEVELOPMENT PHASE</span>
                                                <h4 style={{ fontSize: '1.15rem', fontWeight: 900, marginTop: '0.5rem', color: 'var(--foreground)' }}>{stage.name.toUpperCase()}</h4>
                                            </div>
                                            <div style={{ padding: '2rem', backgroundColor: 'white' }}>
                                                <p style={{ color: '#666', fontSize: '0.95rem', lineHeight: '1.7' }}>
                                                    {stage.description || `Highly specialized treatment phase for ${crop.name}. Focus on optimizing nutrient transfer and biometric performance.`}
                                                </p>
                            ...
                            <div style={{ position: 'sticky', top: '100px' }}>
                                <div className="card" style={{ overflow: 'hidden', border: '1px solid #eee' }}>
                                    ...
                                    <div style={{ padding: '2rem' }}>
                                        <h4 style={{ fontSize: '1.1rem', fontWeight: 800, marginBottom: '1rem', textTransform: 'uppercase' }}>Expert support</h4>
                                        <p style={{ fontSize: '0.85rem', color: '#666', lineHeight: '1.6', marginBottom: '1.5rem' }}>
                                            Consult our agronomists for a custom dosage program.
                                        </p>
                                ...
                                {crop.pdfUrl && (
                                    <div className="card" style={{ marginTop: '2rem', padding: '2rem', border: '1px solid #eee' }}>
                                        <h4 style={{ fontSize: '1rem', fontWeight: 800, marginBottom: '1.25rem', textTransform: 'uppercase' }}>Documentation</h4>
                                        <a
                                            href={crop.pdfUrl}
                                            target="_blank"
